        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              <span class="padding-bottom--15">Register your self</span>
              <form @submit.prevent id="stripe-login">
                <div class="field padding-bottom--24">
                  ...
                  <template v-if="$v.information.name.$error">
                    ...
                    <p
                      class="errorMessage"
                      v-if="!$v.information.name.minLength"
                    >
                      Name is must 4 characters.
                    </p>
                  </template>
                </div>
                <div class="field padding-bottom--24">
                  ...
                  <template v-if="$v.information.email.$error">
                    ...
                    <p class="errorMessage" v-if="!$v.information.email.email">
                      email is invalid*
                    </p>
                  </template>
                </div>
                <div class="field padding-bottom--24">
                  ...
                  <input
                    ...
                    @blur="$v.information.password.$touch()"
                  />
                ...
                <div class="field padding-bottom--24">
                  ...
                  <input
                    ...
                    @blur="$v.information.confirmPassword.$touch()"
                  />
    ...
    information: {
      ...
      confirmPassword: {
        ...
        sameAs: sameAs(function () {
          return this.information.password;
        }),
      },
    },
  },
